...
export const modal = {
    ...
    init() {
        ...
        PT_STATE.$PROJECT.off('.click.clickModal').on('click.clickModal', '[data-role="btnModal"]', function (e) {
            ...
            winHeight > targetHeight ? $target.css('top', winTop + (winHeight - targetHeight) / 2) : $target.css('top', winTop);
        ...
        PT_STATE.$PROJECT.off('click.closeModal').on('click.closeModal', '[data-role="closeModal"]', function (e) {
            ...
            const $modal = $(`[data-role="btnModal"][data-target="${target}"]`);
            const video = $modal.attr('data-video');
            const youtube = $modal.attr('data-youtube');
